...
Obsidian Weave supports several ways to create cards: standard new card, selected text, AI card generation, batch parsing, and importing from external files in multiple formats. Here is a detailed guide:
...
The latest Weave EPUB Reader adds a vocabulary feature for assisted reading of English originals. It works with adding looked-up words to Weave.
...
3. After selecting text, a lookup popup appears. Click Add to Weave in the bottom-right corner, choose a deck, and the word is added.

> Note: Word cards added to Weave can auto-play pronunciation when you switch cards. US vs. UK pronunciation defaults follow fingertip translation plugin settings.
